"""
Command line utility to generate schema files from the baton swagger open API spec https://developers.strava.com/swagger/swagger.json.
"""
...
SWAGGER_URL: str = 'https://developers.strava.com/swagger/swagger.json'
